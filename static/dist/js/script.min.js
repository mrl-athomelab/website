...
var digitMap={0:"۰",1:"۱",2:"۲",3:"۳",4:"۴",5:"۵",6:"۶",7:"۷",8:"۸",9:"۹"};function toFarsiNumber(t){return t=t.replace(/\d/g,function(t){return digitMap[""+t]})}var load_unix_time=Math.round((new Date).getTime()/1e3);$(document).ready(function(){$(window).on("scroll",function(t){$("div[data-spy]").each(function(){parseInt($(this).data("offset-top"))<$(window).scrollTop()?$(this).addClass("affixed"):$(this).removeClass("affixed")})}),0<$("#particles-js").length&&particlesJS.load("particles-js","/static/data/particles-background.json?ver="+load_unix_time),$(".team-members").owlCarousel({loop:!0,margin:10,responsiveClass:!0,nav:!0,autoplay:!0,autoplayTimeout:3e3,smartSpeed:700,items:1}),setTimeout(function(){$(".preloader").fadeOut(500)},500),$(".btn-target").each(function(){$(this).click(function(){var t=$(this).data("target");$.when($(".preloader").fadeIn(500)).done(function(){window.location=t})})})}),$(function(){$('[data-toggle="tooltip"]').tooltip()});
function members_page(){var e=$(".page-admin-members");e.find(".new-member button").click(function(){var a={firstname:e.find("input[name='firstname']").val(),lastname:e.find("input[name='lastname']").val(),biography:e.find("textarea[name='biography']").val(),socialmedialink:e.find("input[name='socialmedialink']").val(),socialmediatype:e.find("select[name='socialmediatype']").val()};console.log(JSON.stringify(a))})}function administrators_page(){var i=$(".page-admin-administrators");i.find(".admin-table .remove-button").click(function(){var a=$(this);a.attr("disabled","disabled");var e=a.data("id");$.ajax({type:"DELETE",url:"/admin/administrators/rest/"+e}).done(function(a){toastr.success(a.message,a.result.message,{timeOut:3e3})}).fail(function(a){console.log(a),toastr.error("error on submiting, please check console log !","error !",{timeOut:3e3})}).always(function(){a.removeAttr("disabled")})}),i.find(".new-admin button").click(function(){var a={username:i.find("input[name='username']").val(),password:i.find("input[name='password']").val()},e=$(this);e.attr("disabled","disabled"),$.ajax({type:"POST",url:"/admin/administrators/rest",data:JSON.stringify(a)}).done(function(a){toastr.success(a.message,a.result.message,{timeOut:3e3}),location.reload()}).fail(function(a){console.log(a),toastr.error("error on submiting, please check console log !","error !",{timeOut:3e3})}).always(function(){e.removeAttr("disabled")})})}$(document).ready(function(){$(".alert").each(function(){$(this).hasClass("hidden")&&$(this).hide()}),administrators_page(),members_page()});