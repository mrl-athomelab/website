...
var digitMap={0:"۰",1:"۱",2:"۲",3:"۳",4:"۴",5:"۵",6:"۶",7:"۷",8:"۸",9:"۹"};function toFarsiNumber(a){return a=a.replace(/\d/g,function(a){return digitMap[""+a]})}var load_unix_time=Math.round((new Date).getTime()/1e3);$(document).ready(function(){$(window).on("scroll",function(a){$("div[data-spy]").each(function(){parseInt($(this).data("offset-top"))<$(window).scrollTop()?$(this).addClass("affixed"):$(this).removeClass("affixed")})}),0<$("#particles-js").length&&particlesJS.load("particles-js","/static/data/particles-background.json?ver="+load_unix_time),$(".team-members").owlCarousel({loop:!0,margin:10,responsiveClass:!0,nav:!0,autoplay:!0,autoplayTimeout:3e3,smartSpeed:700,items:1}),setTimeout(function(){$(".preloader").fadeOut(500)},500),$(".btn-target").each(function(){$(this).click(function(){var a=$(this).data("target");$.when($(".preloader").fadeIn(500)).done(function(){window.location=a})})});var a=$("body").data("page");$(".mainmenu-area .nav-item").each(function(){$(this).data("page")==a&&$(this).addClass("active")})}),$(function(){$('[data-toggle="tooltip"]').tooltip()});
function members_page(){var t=$(".page-admin-members");t.find(".members-table .remove-button").click(function(){var e=$(this);e.attr("disabled","disabled");var a=e.data("id");$.ajax({type:"DELETE",url:"/admin/members/rest/"+a}).done(function(e){toastr.success(e.message,e.result.message,{timeOut:3e3}),$(".member-"+a).fadeOut()}).fail(function(e){console.log(e),toastr.error("error on submiting, please check console log !","error !",{timeOut:3e3})}).always(function(){e.removeAttr("disabled")})}),t.find(".new-member button").click(function(){var e={firstname:t.find("input[name='firstname']").val(),lastname:t.find("input[name='lastname']").val(),biography:t.find("textarea[name='biography']").val(),socialmedialink:t.find("input[name='socialmedialink']").val(),socialmediatype:t.find("select[name='socialmediatype']").val(),rule:t.find("input[name='rule']").val()},a=$(this);a.attr("disabled","disabled"),$.ajax({type:"POST",url:"/admin/members/rest/",data:JSON.stringify(e)}).done(function(e){toastr.success(e.message,e.result.message,{timeOut:3e3}),location.reload()}).fail(function(e){console.log(e),toastr.error("error on submiting, please check console log !","error !",{timeOut:3e3})}).always(function(){a.removeAttr("disabled")})})}function administrators_page(){var t=$(".page-admin-administrators");t.find(".admin-table .remove-button").click(function(){var e=$(this);e.attr("disabled","disabled");var a=e.data("id");$.ajax({type:"DELETE",url:"/admin/administrators/rest/"+a}).done(function(e){toastr.success(e.message,e.result.message,{timeOut:3e3}),$(".administrator-"+a).fadeOut()}).fail(function(e){console.log(e),toastr.error("error on submiting, please check console log !","error !",{timeOut:3e3})}).always(function(){e.removeAttr("disabled")})}),t.find(".new-admin button").click(function(){var e={username:t.find("input[name='username']").val(),password:t.find("input[name='password']").val()},a=$(this);a.attr("disabled","disabled"),$.ajax({type:"POST",url:"/admin/administrators/rest",data:JSON.stringify(e)}).done(function(e){toastr.success(e.message,e.result.message,{timeOut:3e3}),location.reload()}).fail(function(e){console.log(e),toastr.error("error on submiting, please check console log !","error !",{timeOut:3e3})}).always(function(){a.removeAttr("disabled")})})}$(document).ready(function(){if($(".alert").each(function(){$(this).hasClass("hidden")&&$(this).hide()}),administrators_page(),members_page(),0<$("#simplemde").length)new SimpleMDE({element:document.getElementById("simplemde")})});