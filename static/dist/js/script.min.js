...
$(document).ready(function(){$(".alert").each(function(){$(this).hasClass("hidden")&&$(this).hide()});var a=$(".page-admin-administrators");a.find(".admin-table .remove-button").click(function(){var e=$(this);e.attr("disabled","disabled");var t=e.data("id");$.ajax({type:"DELETE",url:"/admin/administrators/rest/"+t}).done(function(e){toastr.success(e.message,e.result.message,{timeOut:3e3})}).fail(function(e){console.log(e),toastr.error("error on submiting, please check console log !","error !",{timeOut:3e3})}).always(function(){e.removeAttr("disabled")})}),a.find(".new-admin button").click(function(){var e={username:a.find("input[name='username']").val(),password:a.find("input[name='password']").val(),csrf_token:a.find("input[name='csrf_token']").val()},t=$(this);t.attr("disabled","disabled"),$.ajax({type:"POST",url:"/admin/administrators/rest",data:JSON.stringify(e)}).done(function(e){toastr.success(e.message,e.result.message,{timeOut:3e3}),location.reload()}).fail(function(e){console.log(e),toastr.error("error on submiting, please check console log !","error !",{timeOut:3e3})}).always(function(){t.removeAttr("disabled")})})});